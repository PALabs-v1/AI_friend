...
Brain-first cognitive architecture; see `ARCHITECTURE.md` for the full design and `.agents/CONTEXT.md` for the engineering ledger — where the two disagree, the ledger is right.

Cognitive core: `backend/app/cognitive/pipeline.py`, `backend/app/cognitive/core.py`, `backend/app/cognitive/decision.py`, `backend/app/cognitive/action.py`, `backend/app/cognitive/behavior_contracts.py`, `backend/app/cognitive/expression.py`, `backend/app/cognitive/identity.py`, `backend/app/cognitive/learning.py`, `backend/app/cognitive/learning_review.py`.

State and memory: `backend/app/state/agent_state.py`, `backend/app/state/session_state.py`, `backend/app/state/working_memory_store.py`, `backend/app/state/memory_store.py`.

Agents and boundaries: `backend/app/agents/brain_agent.py`, `backend/app/agents/subconscious_agent.py`, `backend/app/vision/agent.py`, `backend/app/llm/__init__.py`, `backend/app/persona/profile.py`.

Contracts: `backend/app/contracts.py`, `backend/crates/contracts/src/lib.rs`. Doc-drift guard: `backend/tests/test_doc_drift.py` — every path named above must resolve, or that test fails and CI catches it.
...
- Specific file names, function names, line numbers. Not "there's an issue in the classifier" — it's `backend/app/cognitive/expression.py`, line 96.
